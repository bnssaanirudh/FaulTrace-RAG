...
def test_p0_pipeline_execution(world_data, queries_with_gold, tmp_path):
    ...
    count_queries = [
        (q, gr) for q, gr in queries_with_gold if q.family.value == "count" and gr.gold_answer
    ][:5]
...
def test_adversarial_empty_scope(world_data, tmp_path):
    ...
    from faulttrace_core.models import CountSpec, EqPredicate, FactSpec, QueryFamily
