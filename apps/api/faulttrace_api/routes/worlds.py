...
from faulttrace_api.database import WorldRow, get_db
...
@router.get(
    "/worlds", response_model=PaginatedResponse[WorldResponse], summary="List all corpus worlds"
)
...
async def list_world_records(
    ...
    max_rating: float | None = Query(None, ge=1.0, le=5.0),
