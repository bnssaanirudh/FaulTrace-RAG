"""Exported code cells from FaulTrace_Phi4_Corrected_Rerun.ipynb.
Notebook markdown/output cells are intentionally omitted.
"""

# ============================================================
# NOTEBOOK CELL 2 / CODE CELL 1
# ============================================================
# ============================================================
# 0. CONFIGURATION
# ============================================================
...
ROOT = DRIVE / "LIVE_LLM_PHI_CORRECTED_RERUN"
CACHE = ROOT / "cache"
...
def generate_chat(
    ...
    outputs = model.generate(
        **inputs,
        ...
        # Preserve the checkpoint's native multi-EOS termination behavior.
