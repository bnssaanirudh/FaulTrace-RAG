"""Exported code cells from FaulTrace_Q1_LiveLLM_NaturalFailure_Validation_FIXED.ipynb.
...
plt.savefig(
    PLOTS /
    "LIVE_LLM_baseline_vs_RE.pdf",
    bbox_inches="tight",
)

plt.savefig(
    PLOTS /
    "LIVE_LLM_baseline_vs_RE.png",
    dpi=220,
    bbox_inches="tight",
)
...
if len(failures) > 0:
    ...
    plt.savefig(
        PLOTS /
        "LIVE_LLM_R_E_attribution.pdf",
        bbox_inches="tight",
    )

    plt.savefig(
        PLOTS /
        "LIVE_LLM_R_E_attribution.png",
        dpi=220,
        bbox_inches="tight",
    )
