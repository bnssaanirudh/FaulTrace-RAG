...
_COUNT_TEMPLATES = [
    ...
    (
        "cnt_all",
        "What is the total number of reviews in the corpus?",
        "easy",
        "broad",
        "none",
        "none",
    ...
    (
        "cnt_cat_verified",
        "How many verified purchase reviews are there in the {category} category?",
        "easy",
        "narrow",
        "none",
        "none",
    ...
    (
        "cnt_cat_date",
        "How many {category} reviews were submitted in {year}?",
        "easy",
        "narrow",
        "none",
        "none",
    ...
    (
        "cnt_rating_ge",
        "How many reviews have a rating of {min_rating} stars or higher?",
        "easy",
        "broad",
        "none",
        "none",
    ...
    (
        "cnt_cat_rating",
        "How many {category} reviews received exactly {rating} stars?",
        "easy",
        "narrow",
        "none",
        "none",
    ...
    (
        "cnt_verified_all",
        "How many verified purchases are in the entire corpus?",
        "easy",
        "broad",
        "none",
        "none",
    ...
    (
        "cnt_brand_all",
        "How many reviews are there for {brand} products?",
        "easy",
        "narrow",
        "none",
        "none",
    ...
    (
        "cnt_has_price",
        "How many reviews have a listed product price?",
        "easy",
        "broad",
        "high",
        "none",
    ...
    (
        "cnt_cat_unverified",
        "How many unverified reviews are in the {category} category?",
        "easy",
        "narrow",
        "none",
        "none",
    ...
    (
        "cnt_high_rating",
        "How many reviews have a rating of 4 stars or above?",
        "easy",
        "broad",
        "none",
        "none",
    ...
    (
        "cnt_date_range",
        "How many reviews were submitted between {start_date} and {end_date}?",
        "medium",
        "selective",
        "none",
        "none",
    ...
    (
        "cnt_cat_brand",
        "How many reviews for {brand} products are in the {category} category?",
        "medium",
        "selective",
        "none",
        "none",
    ...
    (
        "cnt_price_range",
        "How many products are priced between ${low_price} and ${high_price}?",
        "medium",
        "selective",
        "high",
        "none",
    ...
    (
        "cnt_verified_cat",
        "How many verified purchases are there across Electronics and Books combined?",
        "medium",
        "selective",
        "none",
        "none",
    ...
    (
        "cnt_cat_year_brand",
        "How many {category} reviews from {brand} were submitted in {year}?",
        "medium",
        "selective",
        "none",
        "none",
    ...
    (
        "cnt_empty_scope",
        "How many reviews have a rating of exactly 6 stars?",
        "adversarial",
        "selective",
        "none",
        "none",
    ...
    (
        "cnt_null_price",
        "How many reviews have a missing product price?",
        "adversarial",
        "broad",
        "high",
        "none",
    ...
    (
        "cnt_multi_cat",
        "How many reviews are in either {cat_a} or {cat_b}?",
        "adversarial",
        "selective",
        "none",
        "none",
    ...
    (
        "cnt_rating_lt",
        "How many reviews have a rating strictly below {max_rating} stars?",
        "adversarial",
        "broad",
        "none",
        "none",
    ...
    (
        "cnt_boundary_date",
        "How many reviews were submitted on the last day of {year}?",
        "adversarial",
        "selective",
        "none",
        "none",
...
_MEAN_TEMPLATES = [
    ...
    (
        "mean_rating_all",
        "What is the overall mean rating across all reviews?",
        "easy",
        "broad",
        "none",
        "none",
    ...
    (
        "mean_rating_cat",
        "What is the mean rating for {category} products?",
        "easy",
        "narrow",
        "none",
        "none",
    ...
    (
        "mean_price_cat",
        "What is the average price of {category} products, excluding items with missing prices?",
        "easy",
        "narrow",
        "high",
        "none",
    ...
    (
        "mean_rating_brand",
        "What is the average star rating for {brand} products?",
        "easy",
        "narrow",
        "none",
        "none",
    ...
    (
        "mean_rating_verified",
        "What is the mean rating for verified purchases?",
        "easy",
        "broad",
        "none",
        "none",
    ...
    (
        "mean_helpful_cat",
        "What is the average number of helpful votes for {category} reviews?",
        "medium",
        "narrow",
        "none",
        "none",
    ...
    (
        "mean_price_verified",
        "What is the average price of verified-purchase products, excluding missing prices?",
        "medium",
        "selective",
        "high",
        "none",
    ...
    (
        "mean_rating_date",
        "What is the mean rating for reviews submitted in {year}?",
        "medium",
        "selective",
        "none",
        "none",
    ...
    # Medium
    (
        "mean_rating_low_rating",
        "What is the average rating among reviews with 1 or 2 stars?",
        "medium",
        "selective",
        "none",
        "none",
    ...
    (
        "mean_price_brand",
        "What is the average price of {brand} products, excluding missing prices?",
        "medium",
        "narrow",
        "high",
        "none",
    ...
    (
        "mean_helpful_verified",
        "What is the average helpful vote count for verified purchases?",
        "medium",
        "broad",
        "none",
        "none",
    ...
    (
        "mean_rating_cat_year",
        "What is the mean rating for {category} products reviewed in {year}?",
        "medium",
        "selective",
        "none",
        "none",
    ...
    (
        "mean_price_all",
        "What is the overall mean price across all products with a listed price?",
        "adversarial",
        "selective",
        "high",
        "none",
    ...
    (
        "mean_rating_unverified",
        "What is the mean rating for unverified (not verified purchase) reviews?",
        "adversarial",
        "broad",
        "none",
        "none",
    ...
    (
        "mean_helpful_all",
        "What is the average number of helpful votes across all reviews?",
        "adversarial",
        "broad",
        "none",
        "none",
...
_PROPORTION_TEMPLATES = [
    ...
    (
        "prop_verified_cat",
        "What proportion of {category} reviews are verified purchases?",
        "easy",
        "narrow",
        "none",
        "none",
    ...
    (
        "prop_high_rating_cat",
        "What fraction of {category} reviews have a rating of 4 or higher?",
        "easy",
        "narrow",
        "none",
        "none",
    ...
    (
        "prop_no_price",
        "What proportion of reviews have a missing price?",
        "easy",
        "broad",
        "high",
        "none",
    ...
    (
        "prop_verified_all",
        "What fraction of all reviews are verified purchases?",
        "easy",
        "broad",
        "none",
        "none",
    ...
    (
        "prop_five_star_cat",
        "What percentage of {category} reviews received 5 stars?",
        "easy",
        "narrow",
        "none",
        "none",
    ...
    (
        "prop_has_price_brand",
        "What proportion of {brand} products have a listed price?",
        "easy",
        "narrow",
        "high",
        "none",
    ...
    (
        "prop_low_rating",
        "What fraction of all reviews have a rating of 2 stars or below?",
        "easy",
        "broad",
        "none",
        "none",
    ...
    (
        "prop_high_rating_all",
        "What proportion of all reviews received 4 stars or more?",
        "easy",
        "broad",
        "none",
        "none",
    ...
    (
        "prop_helpful_cat",
        "What proportion of {category} reviews have at least one helpful vote?",
        "medium",
        "narrow",
        "none",
        "none",
    ...
    (
        "prop_top_brand",
        "What proportion of {category} reviews are from the brand {brand}?",
        "medium",
        "selective",
        "none",
        "none",
    ...
    (
        "prop_recent",
        "What proportion of reviews were submitted in 2022 or later?",
        "medium",
        "broad",
        "none",
        "none",
    ...
    (
        "prop_verified_brand",
        "What fraction of {brand} reviews are verified purchases?",
        "medium",
        "narrow",
        "none",
        "none",
    ...
    (
        "prop_priced_verified",
        "Among verified purchases, what proportion have a listed price?",
        "medium",
        "selective",
        "high",
        "none",
    ...
    (
        "prop_high_helpful",
        "What proportion of reviews have more than 10 helpful votes?",
        "medium",
        "selective",
        "none",
        "none",
    ...
    (
        "prop_unverified_low_rating",
        "What proportion of unverified reviews have a rating below 3?",
        "medium",
        "selective",
        "none",
        "none",
    ...
    (
        "prop_five_star_all",
        "What percentage of all reviews are 5-star?",
        "adversarial",
        "broad",
        "none",
        "low",
    ...
    (
        "prop_null_price_cat",
        "What fraction of {category} products are missing a price?",
        "adversarial",
        "narrow",
        "high",
        "none",
    ...
    (
        "prop_cat_of_all",
        "What fraction of all reviews belong to the {category} category?",
        "adversarial",
        "selective",
        "none",
        "none",
    ...
    (
        "prop_recent_verified",
        "What proportion of verified purchases were submitted after 2021?",
        "adversarial",
        "selective",
        "none",
        "none",
    ...
    (
        "prop_brand_of_cat",
        "Among {category} reviews, what proportion come from {brand}?",
        "adversarial",
        "selective",
        "none",
        "none",
...
_COMPARISON_TEMPLATES = [
    ...
    (
        "cmp_rating_cats",
        "Which has a higher mean rating: {cat_a} or {cat_b}?",
        "easy",
        "selective",
        "none",
        "low",
    ...
    (
        "cmp_count_cats",
        "Which category has more reviews: {cat_a} or {cat_b}?",
        "easy",
        "selective",
        "none",
        "low",
    ...
    (
        "cmp_verified_vs_unverified",
        "Is the mean rating higher for verified or unverified purchases in {category}?",
        "easy",
        "narrow",
        "none",
        "low",
    ...
    (
        "cmp_brand_count",
        "Which brand has more reviews: {brand_a} or {brand_b}?",
        "easy",
        "selective",
        "none",
        "low",
    ...
    (
        "cmp_cat_verified_rate",
        "Which category has a higher rate of verified purchases: {cat_a} or {cat_b}?",
        "easy",
        "selective",
        "none",
        "low",
    ...
    (
        "cmp_year_count",
        "Did the corpus receive more reviews in {year_a} or {year_b}?",
        "medium",
        "selective",
        "none",
        "low",
    ...
    (
        "cmp_brand_rating",
        "What is the difference in mean rating between {brand_a} and {brand_b}?",
        "medium",
        "selective",
        "none",
        "low",
    ...
    (
        "cmp_price_cats",
        "What is the ratio of mean price between {cat_a} and {cat_b}?",
        "medium",
        "selective",
        "high",
        "none",
    ...
    (
        "cmp_helpful_cats",
        "Which category has a higher average helpful vote count: {cat_a} or {cat_b}?",
        "medium",
        "selective",
        "none",
        "low",
    ...
    (
        "cmp_verified_price_cat",
        "Is the mean price higher for verified or unverified purchases in {category}?",
        "medium",
        "narrow",
        "high",
        "low",
    ...
    # Adversarial
    (
        "cmp_near_equal_rating",
        "Compare the mean rating between {cat_a} and {cat_b}: which is higher?",
        "adversarial",
        "selective",
        "none",
        "high",
    ...
    (
        "cmp_cat_year_count",
        "In {category}, were there more reviews in {year_a} or {year_b}?",
        "adversarial",
        "selective",
        "none",
        "low",
    ...
    (
        "cmp_brand_price_ratio",
        "What is the ratio of mean price between {brand_a} and {brand_b}?",
        "adversarial",
        "selective",
        "high",
        "none",
    ...
    (
        "cmp_q1_q2_count",
        "Did {category} receive more reviews in Q1 or Q2 of {year}?",
        "adversarial",
        "selective",
        "none",
        "low",
    ...
    (
        "cmp_null_rate_cats",
        "Which category has a higher proportion of missing prices: {cat_a} or {cat_b}?",
        "adversarial",
        "selective",
        "high",
        "low",
...
_TOPK_TEMPLATES = [
    ...
    (
        "topk_brands_reviews",
        "Which {k} brands have the most reviews?",
        "easy",
        "broad",
        "none",
        "low",
    ...
    (
        "topk_cats_reviews",
        "What are the top {k} categories by review count?",
        "easy",
        "broad",
        "none",
        "low",
    ...
    (
        "topk_brands_rating",
        "Which {k} brands have the highest average rating?",
        "easy",
        "broad",
        "none",
        "low",
    ...
    (
        "topk_cats_rating",
        "What are the top {k} categories by mean rating?",
        "easy",
        "broad",
        "none",
        "low",
    ...
    (
        "topk_brands_count_cat",
        "Which {k} brands have the most {category} reviews?",
        "easy",
        "narrow",
        "none",
        "low",
    ...
    (
        "topk_cats_mean_price",
        "Which {k} categories have the highest average price?",
        "medium",
        "broad",
        "high",
        "low",
    ...
    (
        "topk_brands_helpful",
        "Which {k} brands have the most helpful votes on average?",
        "medium",
        "broad",
        "none",
        "low",
    ...
    (
        "topk_brands_verified_rate",
        "Which {k} brands have the highest verified purchase rate?",
        "medium",
        "broad",
        "none",
        "low",
    ...
    (
        "topk_cats_count_year",
        "What are the top {k} categories by review count in {year}?",
        "medium",
        "selective",
        "none",
        "low",
    ...
    (
        "topk_brands_tie",
        "What are the top {k} brands by review count, breaking ties alphabetically?",
        "adversarial",
        "broad",
        "none",
        "high",
    ...
    (
        "topk_cats_price_cat",
        "Among products with a listed price, which {k} categories have the highest mean price?",
        "adversarial",
        "selective",
        "high",
        "low",
    ...
    (
        "topk_brands_low_rating",
        "Which {k} brands have the lowest average rating?",
        "adversarial",
        "broad",
        "none",
        "low",
    ...
    (
        "topk_brands_count_verified",
        "Among verified purchases, which {k} brands have the most reviews?",
        "adversarial",
        "selective",
        "none",
        "low",
    ...
    (
        "topk_cats_proportion_5star",
        "Which {k} categories have the highest proportion of 5-star reviews?",
        "adversarial",
        "broad",
        "none",
        "low",
...
_TREND_TEMPLATES = [
    ...
    (
        "trend_monthly_count",
        "How does the number of reviews change month by month?",
        "easy",
        "broad",
        "none",
        "none",
    ...
    (
        "trend_quarterly_rating",
        "How does the average rating change quarter by quarter?",
        "easy",
        "broad",
        "none",
        "none",
    ...
    (
        "trend_monthly_count_cat",
        "How does the number of {category} reviews change month by month?",
        "easy",
        "narrow",
        "none",
        "none",
    ...
    (
        "trend_yearly_count",
        "How does the annual review count change year over year?",
        "easy",
        "broad",
        "none",
        "none",
    ...
    (
        "trend_quarterly_count",
        "How do review counts trend by quarter?",
        "easy",
        "broad",
        "none",
        "none",
    ...
    # Medium
    (
        "trend_quarterly_count_verified",
        "How do verified purchase review counts trend by quarter?",
        "medium",
        "selective",
        "none",
        "none",
    ...
    (
        "trend_monthly_price_cat",
        "How does the average price of {category} products trend month by month?",
        "medium",
        "narrow",
        "high",
        "none",
    ...
    (
        "trend_yearly_rating",
        "How does the mean rating trend year over year?",
        "medium",
        "broad",
        "none",
        "none",
    ...
    (
        "trend_monthly_count_brand",
        "How does the monthly review count for {brand} change over time?",
        "medium",
        "narrow",
        "none",
        "none",
    ...
    (
        "trend_quarterly_proportion_verified",
        "How does the proportion of verified purchases change by quarter?",
        "medium",
        "broad",
        "none",
        "none",
    ...
    # Adversarial
    (
        "trend_monthly_count_date_range",
        "How does the monthly review count trend from {start_date} to {end_date}?",
        "adversarial",
        "selective",
        "none",
        "none",
    ...
    (
        "trend_quarterly_price_all",
        "How does the mean price trend by quarter across all products with prices?",
        "adversarial",
        "broad",
        "high",
        "none",
    ...
    (
        "trend_yearly_count_cat",
        "How does the annual review count for {category} trend over time?",
        "adversarial",
        "narrow",
        "none",
        "none",
    ...
    (
        "trend_monthly_helpful",
        "How does the average helpful vote count trend month by month?",
        "adversarial",
        "broad",
        "none",
        "none",
    ...
    (
        "trend_yearly_proportion_5star",
        "How does the proportion of 5-star reviews change year over year?",
        "adversarial",
        "broad",
        "none",
        "none",
...
class QueryFactory:
    ...
    def _make_count_query(
        self, template: tuple, context: dict, rng: random.Random
    ) -> QuerySpec | None:
        tid = template[0]
        tmpl = template[1]
        ...
        if tid == "cnt_all":
            return QuerySpec(
                ...
                natural_language_question=tmpl,
            ...
            return QuerySpec(
                family=QueryFamily.COUNT,
                natural_language_question=tmpl.format(category=cat),
                scope_predicate=AndPredicate(
                    operands=[
                        EqPredicate(field="category", value=cat),
            ...
            return QuerySpec(
                family=QueryFamily.COUNT,
                natural_language_question=tmpl.format(category=cat, year=year),
                scope_predicate=AndPredicate(
                    operands=[
                        EqPredicate(field="category", value=cat),
                        RangePredicate(
                            field="event_time", low=start.isoformat(), high=end.isoformat()
                        ),
                    ]
                ),
            ...
            return QuerySpec(
                family=QueryFamily.COUNT,
                natural_language_question=tmpl.format(min_rating=min_rating),
            ...
            return QuerySpec(
                family=QueryFamily.COUNT,
                natural_language_question=tmpl.format(category=cat, rating=rating),
                scope_predicate=AndPredicate(
                    operands=[
                        EqPredicate(field="category", value=cat),
                        EqPredicate(field="rating", value=rating),
                    ]
                ),
            ...
            return QuerySpec(
                family=QueryFamily.COUNT,
                natural_language_question=tmpl.format(brand=brand),
            ...
            return QuerySpec(
                ...
                scope_predicate=AndPredicate(
                    operands=[
                        EqPredicate(field="category", value=cat),
                        EqPredicate(field="verified_purchase", value=False),
                    ]
                ),
                fact_spec=FactSpec(fields=["record_id", "category", "verified_purchase"]),
                aggregation_spec=CountSpec(),
            ...
            start = datetime(year, 6, 30, tzinfo=UTC)
            end = datetime(year + 1, 1, 1, tzinfo=UTC)
            return QuerySpec(
                family=QueryFamily.COUNT,
                natural_language_question=tmpl.format(start_date=start.date(), end_date=end.date()),
                scope_predicate=RangePredicate(
                    field="event_time",
                    low=start.isoformat(),
                    high=end.isoformat(),
            ...
            return QuerySpec(
                family=QueryFamily.COUNT,
                natural_language_question=tmpl.format(brand=brand, category=cat),
                scope_predicate=AndPredicate(
                    operands=[
                        EqPredicate(field="category", value=cat),
                        EqPredicate(field="brand", value=brand),
                    ]
                ),
            ...
            return QuerySpec(
                family=QueryFamily.COUNT,
                natural_language_question=tmpl.format(low_price=low, high_price=high),
                scope_predicate=AndPredicate(
                    operands=[
                        IsNotNullPredicate(field="price"),
                        RangePredicate(field="price", low=float(low), high=float(high)),
                    ]
                ),
                fact_spec=FactSpec(fields=["record_id", "price"]),
                aggregation_spec=CountSpec(),
            ...
            return QuerySpec(
                ...
                scope_predicate=AndPredicate(
                    operands=[
                        ...
                        InPredicate(
                            field="category",
                            values=[RecordCategory.ELECTRONICS.value, RecordCategory.BOOKS.value],
                        ),
                    ]
                ),
                fact_spec=FactSpec(fields=["record_id", "category", "verified_purchase"]),
            ...
            return QuerySpec(
                family=QueryFamily.COUNT,
                natural_language_question=tmpl.format(category=cat, brand=brand, year=year),
                scope_predicate=AndPredicate(
                    operands=[
                        EqPredicate(field="category", value=cat),
                        EqPredicate(field="brand", value=brand),
            ...
            return QuerySpec(
                family=QueryFamily.COUNT,
                natural_language_question=tmpl.format(cat_a=cat_a, cat_b=cat_b),
            ...
            return QuerySpec(
                family=QueryFamily.COUNT,
                natural_language_question=tmpl.format(max_rating=max_rating),
                scope_predicate=RangePredicate(
                    field="rating", high=max_rating, high_inclusive=False
                ),
                fact_spec=FactSpec(fields=["record_id", "rating"]),
                aggregation_spec=CountSpec(),
                world_id=world_id,
            ...
            year = rng.choice([2020, 2021, 2022, 2023])
            start = datetime(year, 12, 31, tzinfo=UTC)
            end = datetime(year, 12, 31, 23, 59, 59, tzinfo=UTC)
            return QuerySpec(
                family=QueryFamily.COUNT,
                natural_language_question=tmpl.format(year=year),
                scope_predicate=RangePredicate(
                    field="event_time", low=start.isoformat(), high=end.isoformat()
                ),
                fact_spec=FactSpec(fields=["record_id", "event_time"]),
    ...
    def _make_mean_query(
        ...
        if tid == "mean_rating_all":
            ...
            return QuerySpec(
                ...
                fact_spec=FactSpec(fields=["record_id", "price"]),
                aggregation_spec=MeanSpec(
                    field="price", null_policy=NullPolicy.EXCLUDE, decimal_places=2
                ),
                world_id=world_id,
                template_id=tid,
            )
    ...
    def _make_proportion_query(
        ...
        if tid == "prop_verified_cat":
            ...
            return QuerySpec(
                ...
                aggregation_spec=ProportionSpec(
                    numerator_predicate=RangePredicate(field="rating", low=4.0)
                ),
                world_id=world_id,
                template_id=tid,
                tolerance=1e-4,
            ...
            return QuerySpec(
                ...
                fact_spec=FactSpec(fields=["record_id", "rating"]),
                aggregation_spec=ProportionSpec(
                    numerator_predicate=RangePredicate(field="rating", high=2.0)
                ),
                world_id=world_id,
                template_id=tid,
                tolerance=1e-4,
            ...
            return QuerySpec(
                ...
                aggregation_spec=ProportionSpec(
                    numerator_predicate=RangePredicate(
                        field="helpful_votes", low=1, low_inclusive=True
                    )
                ),
                world_id=world_id,
                template_id=tid,
            ...
            return QuerySpec(
                family=QueryFamily.PROPORTION,
                natural_language_question=tmpl.format(category=cat, brand=brand),
                scope_predicate=EqPredicate(field="category", value=cat),
                fact_spec=FactSpec(fields=["record_id", "brand", "category"]),
                aggregation_spec=ProportionSpec(
                    numerator_predicate=EqPredicate(field="brand", value=brand)
                ),
                world_id=world_id,
                template_id=tid,
                tolerance=1e-4,
            ...
            return QuerySpec(
                ...
                fact_spec=FactSpec(fields=["record_id", "event_time"]),
                aggregation_spec=ProportionSpec(
                    numerator_predicate=RangePredicate(field="event_time", low=cutoff.isoformat())
                ),
                world_id=world_id,
                template_id=tid,
                tolerance=1e-4,
            ...
            return QuerySpec(
                ...
                aggregation_spec=ProportionSpec(
                    numerator_predicate=RangePredicate(
                        field="helpful_votes", low=10, low_inclusive=False
                    )
                ),
                world_id=world_id,
                template_id=tid,
            ...
            return QuerySpec(
                ...
                aggregation_spec=ProportionSpec(
                    numerator_predicate=RangePredicate(
                        field="rating", high=3.0, high_inclusive=False
                    )
                ),
                world_id=world_id,
                template_id=tid,
            ...
            return QuerySpec(
                ...
                fact_spec=FactSpec(fields=["record_id", "category"]),
                aggregation_spec=ProportionSpec(
                    numerator_predicate=EqPredicate(field="category", value=cat)
                ),
                world_id=world_id,
                template_id=tid,
                tolerance=1e-4,
            ...
            cutoff = datetime(2021, 12, 31, 23, 59, 59, tzinfo=UTC)
            return QuerySpec(
                family=QueryFamily.PROPORTION,
                natural_language_question=tmpl,
                scope_predicate=EqPredicate(field="verified_purchase", value=True),
    ...
    def _make_comparison_query(
        ...
        if tid == "cmp_rating_cats":
            ...
            if ca is None:
                return None
            return QuerySpec(
                family=QueryFamily.COMPARISON,
                natural_language_question=tmpl.format(cat_a=ca, cat_b=cb),
                scope_predicate=InPredicate(field="category", values=[ca, cb]),
                fact_spec=FactSpec(fields=["record_id", "category", "rating"]),
                aggregation_spec=ComparisonSpec(
                    measure="mean",
                    field="rating",
                    group_a_predicate=EqPredicate(field="category", value=ca),
                    group_b_predicate=EqPredicate(field="category", value=cb),
                    output="difference",
                ),
                world_id=world_id,
                template_id=tid,
            ...
            return QuerySpec(
                family=QueryFamily.COMPARISON,
                natural_language_question=tmpl.format(brand_a=ba, brand_b=bb),
                scope_predicate=InPredicate(field="brand", values=[ba, bb]),
                fact_spec=FactSpec(fields=["record_id", "brand"]),
                aggregation_spec=ComparisonSpec(
                    measure="count",
                    group_a_predicate=EqPredicate(field="brand", value=ba),
                    group_b_predicate=EqPredicate(field="brand", value=bb),
                    output="difference",
                ),
                world_id=world_id,
                template_id=tid,
            ...
            sa = datetime(ya, 1, 1, tzinfo=UTC)
            ea = datetime(ya, 12, 31, 23, 59, 59, tzinfo=UTC)
            sb = datetime(yb, 1, 1, tzinfo=UTC)
            eb = datetime(yb, 12, 31, 23, 59, 59, tzinfo=UTC)
            return QuerySpec(
                family=QueryFamily.COMPARISON,
                natural_language_question=tmpl.format(year_a=ya, year_b=yb),
                scope_predicate=OrPredicate(
                    operands=[
                        RangePredicate(field="event_time", low=sa.isoformat(), high=ea.isoformat()),
                        RangePredicate(field="event_time", low=sb.isoformat(), high=eb.isoformat()),
                    ]
                ),
                fact_spec=FactSpec(fields=["record_id", "event_time"]),
                aggregation_spec=ComparisonSpec(
                    measure="count",
                    group_a_predicate=RangePredicate(
                        field="event_time", low=sa.isoformat(), high=ea.isoformat()
                    ),
                    group_b_predicate=RangePredicate(
                        field="event_time", low=sb.isoformat(), high=eb.isoformat()
                    ),
                    output="difference",
                ),
                world_id=world_id,
            ...
            return QuerySpec(
                ...
                scope_predicate=AndPredicate(
                    operands=[
                        InPredicate(field="category", values=[ca, cb]),
                        IsNotNullPredicate(field="price"),
                    ]
                ),
            ...
            return QuerySpec(
                family=QueryFamily.COMPARISON,
                natural_language_question=tmpl.format(category=cat, year_a=ya, year_b=yb),
                scope_predicate=AndPredicate(
                    operands=[
                        EqPredicate(field="category", value=cat),
                        OrPredicate(
                ...
                aggregation_spec=ComparisonSpec(
                    measure="count",
                    group_a_predicate=AndPredicate(
                        operands=[
                            EqPredicate(field="category", value=cat),
                            RangePredicate(
                                field="event_time", low=sa.isoformat(), high=ea.isoformat()
                    ...
                    group_b_predicate=AndPredicate(
                        operands=[
                            EqPredicate(field="category", value=cat),
                            RangePredicate(
                                field="event_time", low=sb.isoformat(), high=eb.isoformat()
            ...
            return QuerySpec(
                ...
                scope_predicate=AndPredicate(
                    operands=[
                        InPredicate(field="brand", values=[ba, bb]),
                        IsNotNullPredicate(field="price"),
                    ]
                ),
            ...
            cat = rng.choice(cats)
            year = rng.choice([2021, 2022, 2023])
            sq1 = datetime(year, 1, 1, tzinfo=UTC)
            eq1 = datetime(year, 3, 31, 23, 59, 59, tzinfo=UTC)
            sq2 = datetime(year, 4, 1, tzinfo=UTC)
            eq2 = datetime(year, 6, 30, 23, 59, 59, tzinfo=UTC)
            return QuerySpec(
                family=QueryFamily.COMPARISON,
                natural_language_question=tmpl.format(category=cat, year=year),
                scope_predicate=AndPredicate(
                    operands=[
                        ...
                        OrPredicate(
                            operands=[
                                RangePredicate(
                                    field="event_time", low=sq1.isoformat(), high=eq1.isoformat()
                                ),
                                RangePredicate(
                                    field="event_time", low=sq2.isoformat(), high=eq2.isoformat()
                                ),
                            ]
                        ),
                    ]
    ...
    def _make_topk_query(
        ...
        if tid == "topk_brands_reviews":
            return QuerySpec(
                ...
                natural_language_question=tmpl.format(k=k),
                scope_predicate=RangePredicate(field="rating", low=1.0, high=5.0),
                fact_spec=FactSpec(fields=["record_id", "brand"]),
                aggregation_spec=TopKSpec(
                    group_by_field="brand", measure="count", k=k, tie_policy=TiePolicy.FIRST
                ),
                world_id=world_id,
                template_id=tid,
            )
            ...
            return QuerySpec(
                ...
                fact_spec=FactSpec(fields=["record_id", "category"]),
                aggregation_spec=TopKSpec(
                    group_by_field="category", measure="count", k=k, tie_policy=TiePolicy.FIRST
                ),
                world_id=world_id,
                template_id=tid,
            )
            ...
            if tid == "topk_cats_rating":
                ...
                return QuerySpec(
                    family=QueryFamily.TOP_K,
                    natural_language_question=tmpl.format(k=k, category=cat),
                    scope_predicate=EqPredicate(field="category", value=cat),
                    fact_spec=FactSpec(fields=["record_id", "brand", "category"]),
                    aggregation_spec=TopKSpec(
                        group_by_field="brand", measure="count", k=k, tie_policy=TiePolicy.FIRST
            ...
            return QuerySpec(
                family=QueryFamily.TOP_K,
                natural_language_question=tmpl.format(k=k, year=year),
                scope_predicate=RangePredicate(
                    field="event_time", low=start.isoformat(), high=end.isoformat()
                ),
                fact_spec=FactSpec(fields=["record_id", "category", "event_time"]),
    ...
    def _make_trend_query(
        ...
        if tid == "trend_monthly_count":
            ...
            return QuerySpec(
                ...
                fact_spec=FactSpec(fields=["record_id", "event_time", "verified_purchase"]),
                aggregation_spec=TrendSpec(
                    bucket="quarter", measure="mean", value_field="verified_purchase"
                ),
                world_id=world_id,
                template_id=tid,
                tolerance=1e-4,
            ...
            return QuerySpec(
                ...
                aggregation_spec=TrendSpec(
                    bucket="month", measure="mean", value_field="helpful_votes"
                ),
                world_id=world_id,
                template_id=tid,
                tolerance=1e-4,
